...
## ENTRADA #065 — SCT-013 calibración definitiva con torno real: 6.80A ✅
...
## ENTRADA #064 — SCT-013 filtro software para torno 6.80A
...
## ENTRADA #063 — SCT-013 diagnóstico profundo: EMI ambiental, dcOffset WiFi, recalibración
...
## ENTRADA #062 — SCT-013 auditoría completa + app inicializa en 0
...
## ENTRADA #061 — Eliminar bloque [RFID DBG] del loop()
...
## ENTRADA #060 — ESP32 publica en RPi5 via red Tec-IoT (eth0)
...
## ENTRADA #059 — Perf: velocidad máxima PLC→App, topics fast/kpis separados
...
## ENTRADA #058 — Perf: S7 cycle 100ms, MQTT on-change, app polling 500ms
...
## ENTRADA #057 — Fix: piezas rechazadas requiere AND con C2_Boton_Verde
- **Fecha**: 2026-06-04
...
## ENTRADA #056 — Feature: tecla Z simula scan RFID para demo
- **Fecha**: 2026-06-04
...
## ENTRADA #055 — Fix contadores Cognex independientes del Estampado
- **Fecha**: 2026-06-04
...
## ENTRADA #054 — Fix Quality Gate: leer MQTT en tiempo real
- **Fecha**: 2026-06-04
...
## ENTRADA #053 — Fix Celda 3105: leer MQTT en tiempo real
- **Fecha**: 2026-06-04
...
## ENTRADA #052 — Fix killswitch: lógica invertida corregida
- **Fecha**: 2026-06-04
...
## ENTRADA #051 — Node-RED: MQTT broker → 127.0.0.1, datos PLC verificados
- **Fecha**: 2026-06-04
...
## ENTRADA #050 — PLC IP actualizada a 192.168.1.50
- **Fecha**: 2026-06-04
...
## ENTRADA #049 — Subred final Celda 3105: 192.168.0.x
- **Fecha**: 2026-06-04
...
## ENTRADA #048 — Cambio subred: 192.168.100.x → 192.168.10.x (router Steren)
- **Fecha**: 2026-06-04
...
## ENTRADA #047 — Cierre sesión 2026-06-04: migración PyWebView completa
- **Fecha**: 2026-06-04
...
## ENTRADA #046 — Migración crítica PyWebView: Celda 3105 + RFID filtros/modal/CSV
...
## ENTRADA #045 — Cierre sesión 2026-06-04: SCT fix, RFID diagnóstico, systemd
...
## ENTRADA #044 — Fix: setup() duplicado eliminado y handleRFIDScan() removido
...
## ENTRADA #043 — Systemd rfid-agent + health check arranque + pipeline verificado
...
## ENTRADA #042 — Diagnóstico y fix: datos fantasma RFID + pipeline InfluxDB directo
- **Fecha**: 2026-06-03 20:00
...
## ENTRADA #041 — Bug fix: banner RFID ciclo activo + botón PDF visible
- **Fecha**: 2026-06-03 20:00
...
## ENTRADA #040 — Feature: Trazabilidad RFID completa
...
## ENTRADA #039 — Corrección crítica: fórmula SCT-013 30A/1V (salida voltaje)
...
## ENTRADA #038 — Eliminación modo simulación + corrección algoritmo SCT-013-000
...
## ENTRADA #037 — Deploy Node-RED flujo Celda 3105 via API
...
## ENTRADA #036 — Integración PLC S7-1200 Celda 3105 con App Desktop
...
## ENTRADA #035 — Fix calibración SCT-013 y Trazabilidad en app webview
...
## ENTRADA #034 — Trazabilidad RFID: ciclo inicio/fin de pieza
...
## ENTRADA #032 — Fix: filtro descartaba 6.80A real (bug CAPA 1 formula singleIrms)
- **Fecha**: 2026-05-29
...
## ENTRADA #031 — Fix: 5 capas de filtrado SCT-013 offset LM358 y spikes
- **Fecha**: 2026-05-29
...
## ENTRADA #030 — Fix: filtro ventana SCT-013 elimina offset LM358 (12A falsos)
- **Fecha**: 2026-05-29
...
## ENTRADA #017 — n8n migrado a host network mode (fix EHOSTUNREACH MQTT)
- **Fecha**: 2026-05-29
...
## ENTRADA #016 — Acceso directo en escritorio y script de arranque
- **Fecha**: 2026-05-29
...
## ENTRADA #015 — Fix RBAC: operadores solo ven su propia planta
- **Fecha**: 2026-05-29
...
## ENTRADA #014 — Fix corrupción visual WebKit2GTK en LCD 7" 1024×600
- **Fecha**: 2026-05-29
...
## ENTRADA #013 — UI responsive para pantalla 7" LCD 1024×480
- **Fecha**: 2026-05-29
...
## ENTRADA #012 — Cierre de sesión 2026-05-22 — Diagnóstico LM358_FLOOR
- **Fecha**: 2026-05-22
...
## ENTRADA #009 — Fix: ruido ADC SCT-013 con torno apagado (deadband + mediana)
- **Fecha**: 2026-05-22
...
## ENTRADA #011 — Fix: calibración SCT-013 para lectura real del torno
- **Fecha**: 2026-05-22
...
## ENTRADA #010 — Rediseño app UNIX&Co. — PyWebView + HTML/CSS/JS
- **Fecha**: 2026-05-20
...
## ENTRADA #009 — App desktop conectada a datos reales
- **Fecha**: 2026-05-21
...
## ENTRADA #008 — SCT-013 calibrado y operativo
- **Fecha**: 2026-05-21
...
## ENTRADA #008 — Referencia técnica calibración SCT-013
- **Fecha**: 2026-05-22
...
## ENTRADA #007 — Firmware modo REAL: SCT-013 + Rb=30Ω
- **Fecha**: 2026-05-20
...
## ENTRADA #029 — Resumen sesión: GUI pestañas + gráficas tiempo real + panel RFID
...
## ENTRADA #028 — Pestañas navegables + gráficas matplotlib tiempo real + panel RFID
- **Fecha**: 2026-05-19 00:00
...
## ENTRADA #031 — Diagnóstico RC522 nuevo + arquitectura PyWebView documentada
...
## ENTRADA #030 — Botón "Exportar PDF" en vista web Trazabilidad RFID
...
## ENTRADA #029 — TrazabilidadPanel layout compacto para 1024×600
...
## ENTRADA #028 — Fix botón PDF Trazabilidad siempre visible en 1024×600
- **Fecha**: 2026-06-04 00:00
...
## ENTRADA #027 — Dashboards tiempo real SCT-013 + RFID, modo real activado en GUI
...
## ENTRADA #026 — GUI modo PIN-only + dashboards con datos reales ESP32-S3
...
## ENTRADA #025 — Migración a red Tec-IoT + resolución conflicto git config.py
...
## ENTRADA #024 — Pipeline ESP32→MQTT→InfluxDB→Grafana operativo en red doméstica
- **Fecha**: 2026-05-17
...
## ENTRADA #005 — Modo REAL activado + ajustes para red doméstica
- **Fecha**: 2026-05-17
...
## ENTRADA #023 — Diagnóstico AS608 + fallback timeout + pipeline RFID completo
- **Fecha**: 2026-05-14
- **Estado**: ✅ Completado
...
## ENTRADA #022 — App CustomTkinter 2FA + contexto sesión anterior
- **Fecha**: 2026-05-14
...
## ENTRADA #021 — Prueba física RC522 + SCT-013 en ESP32-S3
- **Fecha**: 2026-05-14
...
## ENTRADA #020 — App desktop operativa en RPi5 + SIMULATION_MODE=False
...
## ENTRADA #019 — App escritorio CustomTkinter con 2FA y RBAC
...
## ENTRADA #018 — HITO MAYOR: Pipeline completo PLC → Grafana operativo
- **Fecha**: 2026-04-20
...
## ENTRADA #017 — HITO: RPi5 ↔ PLC comunicación wireless confirmada
- **Fecha**: 2026-04-20
- **Estado**: ✅ Completado
...
## ENTRADA #016 — HITO: PLC en 192.168.100.50 + PUT/GET habilitado
- **Fecha**: 2026-04-20
- **Estado**: ✅ Completado
...
## ENTRADA #015 — Auditoría autenticación RPi5
- **Fecha**: 2026-04-10
- **Estado**: ✅ Completado
...
## ENTRADA #013 — ESP32 → RPi5 MQTT-TLS puerto 8883 operativo
- **Fecha**: 2026-04-10
- **Estado**: ✅ Completado — datos cada 5s

---

## ENTRADA #006 — Grafana CIMA operativo
- **Fecha**: 2026-03-29
- **Estado**: ✅ Completado | Puerto 3001

---

## ENTRADA #005 — Dashboard Node-RED CIMA operativo
- **Fecha**: 2026-03-29
- **Estado**: ✅ Completado

---

## ENTRADA #004 — Pipeline ESP32 → MQTT → n8n → InfluxDB
- **Fecha**: 2026-03-28
- **Estado**: ✅ Completado — HITO FASE 1

---

## ENTRADA #003 — Primer dato MQTT recibido
- **Fecha**: 2026-03-28
- **Estado**: ✅ Completado — HITO FASE 1
...
- [ ] Conectar SCT-013 al ESP32-S3
- [ ] Probar RC522 RFID — Pasaporte Digital
...
|---------|-------|-------------|
| 0.6.0 | 2026-05-21 | SCT-013 calibrado — medición real de corriente operativa |
| 0.6.0 | 2026-05-19 | GUI: pestañas navegables, gráficas tiempo real, panel RFID |
| 1.6.0 | 2026-05-17 | Pipeline ESP32→MQTT→InfluxDB→Grafana operativo. n8n y Grafana token configurados. |
| 0.5.0 | 2026-05-17 | Modo REAL activado. Puerto Grafana 3001 corregido. Multi-entorno documentado. |
| 1.5.0 | 2026-04-20 | Pipeline completo PLC → Grafana — Celda 3105 en producción |
| 1.4.0 | 2026-04-20 | RPi5 ↔ PLC comunicación wireless confirmada — COM-845 operativo |
| 1.3.0 | 2026-04-20 | PLC S7-1200 en 192.168.100.50 — PUT/GET habilitado |
| 1.2.0 | 2026-04-10 | Auditoría auth RPi5 — Fase 2 definida |
| 1.1.0 | 2026-04-10 | ESP32 → RPi5 MQTT-TLS operativo |
| 1.0.0 | 2026-04-10 | MQTT TLS completo con setCACert() |
| 0.7.0 | 2026-03-29 | Plan ciberseguridad definido |
| 0.6.0 | 2026-03-29 | Grafana KPIs CIMA operativo |
| 0.5.0 | 2026-03-29 | Dashboard Node-RED CIMA operativo |
| 0.4.0 | 2026-03-28 | Pipeline ESP32 → MQTT → n8n → InfluxDB |
| 0.3.0 | 2026-03-28 | Primer dato MQTT recibido |
| 0.2.0 | 2026-03-28 | Stack RPi5 operativo |
